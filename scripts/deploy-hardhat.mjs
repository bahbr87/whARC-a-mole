...
async function main() {
  ...
  console.log("=".repeat(60))
  console.log("RPC URL: https://rpc.arc.network")
  ...
  const prizeAmount = hre.ethers.parseUnits("1000", 6) // 1000 USDC for prizes
  await mockUSDC.transfer(prizePoolAddress, prizeAmount)
  console.log("✅ Transferred", hre.ethers.formatUnits(prizeAmount, 6), "USDC to PrizePool")
