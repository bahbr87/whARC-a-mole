...
async function getDailyRanking(date: Date): Promise<string[]> {
  ...
  // Filtrar rankings do dia específico (UTC)
  ...
  // Ordenar por: score → goldenMoles → errors → timestamp
  ...
  // Retornar apenas endereços (progressive distribution: 1-3 jogadores)
 ...
 */
async function main() {
  console.log("🚀 Iniciando registro diário de vencedores")
  ...
  console.log("📅 Dia UTC:", yesterdayUTC.toISOString().split("T")[0])
